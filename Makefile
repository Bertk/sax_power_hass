...
old_bump:
	bump2version --allow-dirty --current-version $(__VERSION__) patch Makefile custom_components/sax_power/manifest.json/const.py custom_components/sax_power/manifest.json
